...
const Footer = () => {
    return (
        <footer className="footer footer-center mt-10 p-10 bg-black text-white rounded">
            ...
            <div>
                <p>Copyright © 2022 - All right reserved by <small className='text-cyan-500 font-bold'>Shammi Akter</small></p>
            </div>
        </footer>
    );
};
